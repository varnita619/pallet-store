    ...
    <div className="container">
        <div className="horizontal-card">
            <div className="horizontal-card-image">
                ...
                {/* <div className="brand-image" style={{height:'3rem', marginTop:'.5rem', marginLeft:'1rem'}}>
                <img src='https://upload.wikimedia.org/wikipedia/commons/thumb/7/75/Levi%27s_logo.svg/2560px-Levi%27s_logo.svg.png' style={{width:'6.5rem', height:'2.5rem'}}></img>
                </div> */}
            </div>
